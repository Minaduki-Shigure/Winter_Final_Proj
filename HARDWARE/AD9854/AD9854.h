...
static unsigned char freqstay[3]={0xE4,0xE1,0xc0};//驻足时间0.0025s,完成一次扫频（1~40M）1s
static unsigned char ctr[4]={0x00,0x49,0x00,0x00};//控制寄存器值，32位，PLL倍频9倍，单音模式，外部更新时钟，开启SINC
